...
The MiniMax algorithm is used in decision-making, game theory and artificial intelligence (AI).  
 ...
 <sub>
  for a better understanding of the MiniMax algorithm use those links :&ensp;[Article about MiniMax ](https://www.neverstopbuilding.com/blog/minimax), &ensp;[Video about MiniMax ](https://www.youtube.com/watch?v=l-hh51ncgDI&t=553s)
